...
export default function SupportCourierListPage() {
  ...
  async function loadPackages(courier: Courier) {
    ...
    try {
      ...
      // Swagger’daki gibi limit/offset istersen buradan oynarsın
    ...
    return (
      <div className="rounded-2xl bg-white p-6 shadow">
        ...
        <p className="text-sm text-rose-600">
          Bu sayfayı görüntülemek için <strong>Kurye (Modül 1)</strong> yetkisine sahip
          olmanız gerekiyor.
        </p>
      </div>
    );
...
function PackagesModal(props: {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4">
      <div className="w-full max-w-4xl max-h-[85vh] overflow-hidden rounded-2xl bg-white shadow-xl flex flex-col">
